...
localMp.innerHTML = "Your local MP is: Philip Davies<br> Party: conseratives <br> Consituency: Shipley<br>(Wikipedia Contributors, 2019)"
...
socialMedia.addEventListener("click", function(){
  window.location.href="PhilipDavies.html"
})
