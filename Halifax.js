...
localMp.innerHTML = "Your local MP is: Holly Lynch<br> Party:Labour <br> Consituency: Halifax<br>(Holly Lynch, 2024)"
...
socialMedia.addEventListener("click", function(){
  window.location.href="hollyLynch.html"
})
